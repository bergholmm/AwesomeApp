...
const Tabbar = (props) => {
    ...
    if (Platform.OS === 'ios') {
        ...
        addSpot = (
            <TouchableHighlight underlayColor='transparent' onPress={ () => props.changeTab(1) } style={ styles.buttonContainer }>
                <Image source={ require('../../resources/addspotx2Android.png') }style={styles.addSpotAndroid} />
            </TouchableHighlight>
        );
    }
